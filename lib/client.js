...
var CSS = [
  ...
  ".dshsched-module-badge { flex:none; display:inline-flex; align-items:center; justify-content:center; min-width:16px; height:16px; padding:0 5px; box-sizing:border-box; background:var(--dsw-alias-label-primary); color:var(--dsw-alias-label-primary-inverted); border-radius:999px; font-size:11px; }",
...
function TaskPanel(props) {
  ...
  const head = el(
    ...
    el("span", { className: "dshsched-drawer-title" }, "\u23F1 \u5B9A\u65F6\u4EFB\u52A1"),
    el(
      "div",
      { className: "dshsched-row" },
  ...
  const foot = el(
    ...
    (data && data.configPath ? "\u914D\u7F6E: " + data.configPath : "\u5C1A\u672A\u4FDD\u5B58\u914D\u7F6E") + " \xB7 \u5E38\u9A7B\u8C03\u5EA6,\u5173\u95ED\u672C\u9875\u4E0D\u5F71\u54CD\u6267\u884C"
  );
